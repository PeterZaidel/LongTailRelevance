...
//
//
//class NewJoinOnPairsJob extends Configured implements Tool {
//
...
//
//
//    private static final List<String> tf_idf_features_dirs = new ArrayList<>();
//    private static final String TF_IDF_FEATURES_FILENAME_TAG = "tf_idf_features_file";
//
//
...
//        }
//
//        public void map_query_doc_features(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
//
//        }
//
//        public void map_tf_idf_features(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
//            String val = value.toString();
//
//            int query_len = val.indexOf(DELIMETER);
//            String query = val.substring(0, query_len);
...
//    {
//        String qd_features_file = args[0];
//        String url_feature_file = args[1];
//        String query_feature_file = args[2];
//        String tf_idf_directory = args[3];
//
//
//
